'use client'
//este formulario es para editar un registro 
...
export default function Form({ setFormActive, oldPerson, id }) {
    ...
    // en este estado se alamcenaran los errores del formulario
    ...
    //esta funcion se encarga de ver si no hay errores y asi poder editar un registro
    const handleClick = (e) => {
        e.preventDefault();
        if (Object.keys(error).length === 0) {
            dispath(editPersonId(person))
            setFormActive()
        } else {
